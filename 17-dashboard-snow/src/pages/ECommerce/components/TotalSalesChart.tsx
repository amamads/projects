...
export function TotalSalesChart({ className }: ClassProp) {
  return (
    <Card className={cn(className, "overflow-auto")}>
      <CardHeader className="p-0">
        <CardTitle>Traffic by Location</CardTitle>
      </CardHeader>
      <div className="size-30 flex justify-start self-center">
      ...
      <div className="col-flex gap-3 w-30.5 self-center">
        {[
          {
            country: "Direct",
            value: 300.56,
